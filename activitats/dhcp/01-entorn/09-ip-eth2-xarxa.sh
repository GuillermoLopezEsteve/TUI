#!/bin/bash
# TITLE: L'adreça d'eth2 és de la xarxa 192.168.{N}.0/24
# DESCRIPTION: Comprova que eth2 té una adreça IPv4 dins de la xarxa 192.168.{N}.0/24, on {N} és el número d'estudiant.
