#!/bin/bash
# TITLE: L'adreça d'eth2 és 192.168.{N}.2
# DESCRIPTION: Comprova que eth2 té configurada exactament l'adreça IPv4 192.168.{N}.2, on {N} és el número d'estudiant.
